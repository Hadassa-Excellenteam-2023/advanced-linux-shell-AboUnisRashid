...
mv ~/new/name.txt ~/new/rashidab.txt

# 5. Edit the file using gedit – write your name and your favorite animal in it:
# Install gedit if not already installed (skip if already installed)
sudo apt-get install gedit

# Open the file in gedit for editing
gedit ~/new/rashidab.txt
